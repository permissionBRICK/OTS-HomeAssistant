...
The project owner supplied controller address **198.51.100.80**. It is reachable
directly from this VM; the old VM's proxy/tunnel is unnecessary. Controller:
**AIRHAWK518C11A, firmware v3.3.20**. The project owner confirmed that it has **no DHW
